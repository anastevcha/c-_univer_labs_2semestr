...
void part1_task1() {
    ...
    while (*ptr) {
        ...
        while (*ptr && !isdigit(static_cast<unsigned char>(*ptr)) && *ptr != '-') {
            ptr++;
        }
...
void capitalizeUtf8(char* str) {
    ...
    for (int i{}; str[i] != '\0'; ++i) {
        ...
        if (c == ' ' || c == '\t') {
            ...
            str[i + 1] =
                static_cast<char>(
                    static_cast<unsigned char>(str[i + 1]) - 0x20);
...
void part2_task3() {
    ...
    file.write(
        reinterpret_cast<const char*>(&startMarker),
        sizeof(int));
    ...
    file.write(
        reinterpret_cast<const char*>(&endMarker),
        sizeof(int));
    ...
    while (true) {
        ...
        if (part == 1) {
            ...
            while (true) {
                ...
                std::cout << "\n1 - Фразы с буквой а\n";
                std::cout << "2 - Разрыв матрицы\n";
                std::cout << "3 - Бинарный файл\n";
                std::cout << "0 - Назад\n";
                std::cout << "> ";
            ...
            std::cout << "Неверный выбор части. Попробуйте снова.\n\n";
        }
    }
